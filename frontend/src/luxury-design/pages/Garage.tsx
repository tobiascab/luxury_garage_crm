    ...
    >
      ...
      <div className="flex items-end justify-between px-1 pt-2">
        ...
        <div className="text-right pb-1">
          ...
          <p className="text-3xl font-headline font-black text-primary dark:text-blue-400 italic">02</p>
        </div>
      </div>
      ...
      <div className="relative group">
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 shadow-2xl h-72 border border-white/5 group">
          ...
          <div className="absolute top-6 left-6 flex gap-2">
            <span className="bg-primary/80 backdrop-blur-md text-white px-4 py-1.5 rounded-full text-[10px] font-black tracking-widest uppercase border border-white/10 shadow-lg">
              LISTO
            </span>
          </div>
      ...
      {/* Stats Quick Bar */}
      <div className="bg-white/80 dark:bg-slate-900/50 backdrop-blur-md p-6 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm transition-all hover:bg-white dark:hover:bg-slate-900/60">
        <div className="flex justify-between items-center">
          <div className="flex-1">
            ...
            <p className="font-headline font-black text-lg mt-1 text-slate-900 dark:text-white tracking-tighter">1,250 KM</p>
          </div>
          ...
          <button className="flex items-center gap-2 bg-primary dark:bg-blue-600 px-6 py-3.5 rounded-2xl text-white font-black text-[10px] uppercase tracking-widest active:scale-95 transition-all shadow-xl shadow-primary/20 dark:shadow-blue-500/20">
      ...
      {/* Secondary Vehicle */}
      <div className="bg-white/80 dark:bg-slate-900/50 backdrop-blur-md rounded-[2.5rem] p-6 border border-slate-100 dark:border-slate-800 shadow-sm transition-all">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="p-4 bg-slate-50/50 dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-700">
            <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500">Combustible</p>
            <p className="text-sm font-black text-slate-900 dark:text-slate-100 mt-1 uppercase">420 KM <span className="text-[10px] text-slate-400 ml-1">Límite</span></p>
          </div>
          <div className="p-4 bg-slate-50/50 dark:bg-slate-800/40 rounded-2xl border border-slate-100 dark:border-slate-700">
            <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500">Motor</p>
            <p className="text-sm font-black text-slate-900 dark:text-slate-100 mt-1 uppercase">95°C <span className="text-[10px] text-emerald-500 ml-1">Estable</span></p>
          </div>
        </div>

        <button className="w-full py-5 bg-slate-900 dark:bg-white dark:text-slate-900 text-white font-black rounded-2xl active:scale-95 transition-all text-[11px] uppercase tracking-[0.2em] shadow-2xl flex items-center justify-center gap-3 italic">
          <Droplets size={16} />
      ...
      {/* Add Vehicle Form */}
      <div className="bg-white/50 dark:bg-slate-900/30 rounded-[3rem] p-8 border-2 border-dashed border-slate-100 dark:border-slate-800 transition-all hover:border-primary/20 group">
        ...
        <form className="space-y-4">
          ...
          <button
            type="button"
            className="w-full py-5 mt-4 bg-primary dark:bg-blue-600 text-white rounded-2xl font-black tracking-[0.3em] uppercase text-[10px] shadow-2xl transition-all active:scale-95 flex items-center justify-center gap-3 overflow-hidden relative group"
          >
